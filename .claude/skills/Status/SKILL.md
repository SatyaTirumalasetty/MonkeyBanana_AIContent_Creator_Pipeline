...
**In production**: `505d027` (`/videos` history page) — pushed and live-verified. **Committed locally, not yet deployed**: `dc8e2e5` (brief-first UI with auto-detected content type). **No P0s remain open.**
